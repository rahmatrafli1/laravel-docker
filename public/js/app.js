...
/* harmony import */ var _csp_safe_alpine__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./csp-safe-alpine */ "./resources/js/csp-safe-alpine.js");
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js");



// Initialize CSP-safe Alpine.js configuration
(0,_csp_safe_alpine__WEBPACK_IMPORTED_MODULE_1__.initCspSafeAlpine)(alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
/***/ "./resources/js/csp-safe-alpine.js":
/*!*****************************************!*\
  !*** ./resources/js/csp-safe-alpine.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   cspSafeComponents: () => (/* binding */ cspSafeComponents),
/* harmony export */   cspSafeHandlers: () => (/* binding */ cspSafeHandlers),
/* harmony export */   initCspSafeAlpine: () => (/* binding */ initCspSafeAlpine),
/* harmony export */   registerCspSafeComponents: () => (/* binding */ registerCspSafeComponents)
/* harmony export */ });
...
var cspSafeComponents = {
  ...
  form: function form() {
    ...
    return {
      form: _objectSpread({}, initialData),
      errors: {},
      loading: false,
      ...
      setError: function setError(field, message) {
        this.errors[field] = message;
      },
      reset: function reset() {
        this.form = _objectSpread({}, initialData);
        this.errors = {};
        this.loading = false;
      }
    };
  ...
  list: function list() {
    ...
    return {
      items: _toConsumableArray(initialItems),
      selectedItem: null,
 ...
 */
function registerCspSafeComponents(Alpine) {
  Object.keys(cspSafeComponents).forEach(function (componentName) {
...
var cspSafeHandlers = {
  ...
  preventAndStop: function preventAndStop(event) {
    event.preventDefault();
    event.stopPropagation();
  },
  // Submit form with loading state
  submitForm: function submitForm(formElement, loadingElement) {
 ...
 * Initialize CSP-safe Alpine.js configuration
 */
function initCspSafeAlpine(Alpine) {
  // Register components
